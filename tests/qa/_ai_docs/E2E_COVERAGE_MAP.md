...
| **Server Management** | Start Server | `anaconda-mcp serve --port 8888` | CORE-001, CLI-002 |
...
| | Setup HTTP | `setup-config --transport streamable-http` | CORE-001, CLI-003 |
...
| | Port Override | `--port 8888` | CFG-002, CORE-001 |
| **Transport** | STDIO | Default for Claude Desktop | CORE-001 |
| | HTTP | `--transport streamable-http` | CORE-001 |
...
### TESTS_API_TOOLS.md (All platforms)

| Test ID | Name | Features |
|---------|------|----------|
| TOOL-001 to 006 | Tool Tests | 6 MCP tools |
| ERR-001 to 005 | Error Scenarios | 5 error cases (3 tool + 2 protocol) |
